...
<body>
    ...
    <div id="content">
        <header>
            <h1>
                <a href="#home" onClick="return false;" class="active site">
                    PORTFOLIO
                </a>
            </h1>
        </header>

        <div id="grid" class="home fade">
            <?php
        ...
        <div class="impressum fade">
            ...
            <h2>Kontakt</h2>
            <p>E-Mail: s.steil2 [ät] gmail [punkt] com</p>
            ...
            <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Stefan Steil</p>
            <p>E-Mail: s.steil2 [ät] gmail [punkt] com</p>
        ...
        <footer>
            2022 | <a href="#impressum" onClick="return false;" class="site">Impressum/Datenschutz</a> | <a href="https://github.com/matz-git/portfolio" target="_blank">code</a> 
        </footer>
    </div><!-- content -->
</body>
</html>